...
export default function () {
    let self = this;
    let btnPreview = $(`<a href="javascript:void(0);" title="Preview OFF" class="${CLASS_NAMES.UI} ${CLASS_NAMES.TOPBAR_BUTTON}">${ICONS.PREVIEW_OFF}</a>`);
    ...
    btnPreview.on('click', function (e) {
        ...
        btnPreview.attr('title', isPreviewOn ? 'Preview ON' : 'Preview OFF');
